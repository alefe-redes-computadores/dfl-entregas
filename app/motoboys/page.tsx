...
export default function MotoboysPage(){
  ...
  return <div className="dfl-page"><PageHeader title="Equipe de motoboys" subtitle="Histórico, regras e acertos" to="/loja"/>
    ...
    <div className="relative"><Search size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500"/><input value={query} onChange={event=>setQuery(event.target.value)} placeholder="Buscar entregador" className="dfl-search pl-11 pr-4 focus:border-sky-500/50"/></div>
