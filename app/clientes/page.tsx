...
export default function CustomersPage(){
  ...
  const duplicateCount=useMemo(()=>customerDuplicateCandidates(customers,deliveries).length,[customers,deliveries]);
